...
fn flash_permission_test(opts: &Opts, transport: &TransportWrapper) -> Result<()> {
    ...
    if opts.dual_owner_boot_check {
        ...
        assert_eq!(
            region[0],
            FlashRegion("data", 0, OWNER_FLASH_ROM_EXT_START as u32, OWNER_FLASH_ROM_EXT_SIZE as u32, romext_region[0], "LK")
        );
        assert_eq!(
            region[1],
            FlashRegion("data", 1, 256+OWNER_FLASH_ROM_EXT_START as u32, OWNER_FLASH_ROM_EXT_SIZE as u32, romext_region[1], "LK")
        );
        ...
        assert_eq!(
            region[2],
            FlashRegion("data", 2, 256+OWNER_FLASH_OWNER_START as u32, OWNER_FLASH_OWNER_SIZE as u32, "RD-WR-ER-SC-EC-xx", "UN")
        );
        assert_eq!(
            region[3],
            FlashRegion("data", 3, 256+OWNER_FLASH_FILE_START as u32, OWNER_FLASH_FILE_SIZE as u32, "RD-WR-ER-xx-xx-HE", "UN")
        );
    ...
    let app_region = match opts.rescue_slot {
        BootSlot::SlotA => [
            ...
            FlashRegion("data", 2, OWNER_FLASH_OWNER_START as u32, OWNER_FLASH_OWNER_SIZE as u32, "RD-xx-xx-SC-EC-xx", locked),
            FlashRegion("data", 3, OWNER_FLASH_FILE_START as u32, OWNER_FLASH_FILE_SIZE as u32, "RD-WR-ER-xx-xx-HE", locked),
            FlashRegion("data", 4, 256+OWNER_FLASH_OWNER_START as u32, OWNER_FLASH_OWNER_SIZE as u32, "RD-WR-ER-SC-EC-xx", locked),
            FlashRegion("data", 5, 256+OWNER_FLASH_FILE_START as u32, OWNER_FLASH_FILE_SIZE as u32, "RD-WR-ER-xx-xx-HE", locked),
        ],
        BootSlot::SlotB => [
            // Slot A writable, Slot B protected.
            FlashRegion("data", 2, OWNER_FLASH_OWNER_START as u32, OWNER_FLASH_OWNER_SIZE as u32, "RD-WR-ER-SC-EC-xx", locked),
            FlashRegion("data", 3, OWNER_FLASH_FILE_START as u32, OWNER_FLASH_FILE_SIZE as u32, "RD-WR-ER-xx-xx-HE", locked),
            FlashRegion("data", 4, 256+OWNER_FLASH_OWNER_START as u32, OWNER_FLASH_OWNER_SIZE as u32, "RD-xx-xx-SC-EC-xx", locked),
            FlashRegion("data", 5, 256+OWNER_FLASH_FILE_START as u32, OWNER_FLASH_FILE_SIZE as u32, "RD-WR-ER-xx-xx-HE", locked),
        ],
        _ => return Err(anyhow!("Unknown boot slot {}", data.bl0_slot)),
    };
